...
async function postSessionData_postSessionData(data, myPrivateKey, myPublicKey, sessionData, sessionId, env) {
    //
...
async function authUser(userParameters, keys, sessionId, sessionData, env, local) {
    ...
    //
    window.focus()
    const ezwebauthn = new ezwebauthn_EZWebAuthn()
    ...
    if (!local) {
        ...
        await postSessionData_postSessionData(
            output,
...
;// CONCATENATED MODULE: ./src/js/mobile/webauthRegister.mjs
async function webauthRegister(data, keys, sessionData, sessionId, env) {
    {
        //
